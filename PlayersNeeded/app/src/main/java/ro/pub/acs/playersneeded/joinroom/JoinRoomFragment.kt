...
class JoinRoomFragment : Fragment() {
    ...
    private fun setPreferences(view: View, dialog: Dialog?) {
        ...
        val applyFiltersButton = dialog?.findViewById(R.id.applyFiltersButton) as Button
        ...
        val dateFromInput = dialog.findViewById(R.id.textViewDateStart) as TextView

        dateFromInput.setOnClickListener {
            setDate(day, month, year, dateFromInput)
        }

        val timeFromInput = dialog.findViewById(R.id.textViewTimeStart) as TextView

        timeFromInput.setOnClickListener {
            setTime(hour, minute, timeFromInput)
        }

        val dateUntilInput = dialog.findViewById(R.id.textViewDateEnd) as TextView

        dateUntilInput.setOnClickListener {
            setDate(day, month, year, dateUntilInput)
        }

        val timeUntilInput = dialog.findViewById(R.id.textViewTimeEnd) as TextView
    ...
    private fun setFilterValues(dialog: Dialog?) {
        val roomNameInput = dialog?.findViewById(R.id.filterPreferenceInputRoomName) as EditText
        val sportTypeInput = dialog.findViewById(R.id.spinnerSport) as Spinner
        val skillLevelInput = dialog.findViewById(R.id.spinnerSkillLevel) as Spinner
        val dateFromInput = dialog.findViewById(R.id.textViewDateStart) as TextView
        val timeFromInput = dialog.findViewById(R.id.textViewTimeStart) as TextView
        val dateUntilInput = dialog.findViewById(R.id.textViewDateEnd) as TextView
        val timeUntilInput = dialog.findViewById(R.id.textViewTimeEnd) as TextView
